...
with tab1:
    ...
    st.plotly_chart(fig_evolution, use_container_width=True, key="fig_evolution_interets_composes")
    ...
    if 'results' in st.session_state and st.session_state['results']:
        ...
        if selected_stocks:
            ...
            for stock in selected_stocks:
                ...
                st.plotly_chart(fig_pie, use_container_width=True, key=f"fig_pie_portfolio_{len(selected_stocks)}")
...
with tab3:
    ...
    st.plotly_chart(fig_performance, use_container_width=True, key="fig_performance_historique")
    ...
    if st.session_state['portfolio']['pea'] or st.session_state['portfolio']['compte_titre'] or st.session_state['portfolio'].get('crypto_kraken', []):
        ...
        if total_investi_global > 0 or total_comptes_bancaires > 0:
            ...
            with col1:
                ...
                if total_investi_global > 0:
                        ...
                        st.plotly_chart(fig_repartition, use_container_width=True, key="fig_repartition_portefeuille")
        ...
        if all_positions:
            ...
            if evolution_clean:
                    ...
                    st.plotly_chart(fig_evolution, use_container_width=True, key="fig_evolution_portefeuille_hebdo")
